var FileUploadWithPreview = function () {
    ...
    var A, e = (function (A) {
        var e = function (A) {
            ...
            function r(A, e, t, g) {
                var n = e && e.prototype instanceof c ? e : c, i = Object.create(n.prototype), B = new k(g || []);
            ...
            A.wrap = r;
            var o = "suspendedStart", I = "suspendedYield", Q = "executing", a = "completed", s = {};
            ...
            var m = Object.getPrototypeOf, f = m && m(m(J([])));
            ...
            function S(A, t) {
                ...
                var i = n.arg;
                return i ? i.done ? (t[A.resultName] = i.value, t.next = A.nextLoc, "return" !== t.method && (t.method = "next", t.arg = e), t.delegate = null, s) : i : (t.method = "throw", t.arg = new TypeError("iterator result is not an object"), t.delegate = null, s)
            }
            ...
            return u.prototype = d.constructor = l, l.constructor = u, l[E] = u.displayName = "GeneratorFunction", A.isGeneratorFunction = function (A) {
                ...
                return {__await: A}
            }, p(v.prototype), v.prototype[B] = function () {
                return this
            }, A.AsyncIterator = v, A.async = function (e, t, g, n) {
                var i = new v(r(e, t, g, n));
                return A.isGeneratorFunction(t) ? i : i.next().then(function (A) {
                    return A.done ? A.value : i.next()
                })
            }, p(d), d[E] = "Generator", d[i] = function () {
                return this
            }, d.toString = function () {
                ...
                constructor: k, reset: function (A) {
                    if (this.prev = 0, this.next = 0, this.sent = this._sent = e, this.done = !1, this.delegate = null, this.method = "next", this.arg = e, this.tryEntries.forEach(w), !A) for (var t in this) "t" === t.charAt(0) && g.call(this, t) && !isNaN(+t.slice(1)) && (this[t] = e)
                }, stop: function () {
                    this.done = !0;
                    ...
                    for (var i = this.tryEntries.length - 1; i >= 0; --i) {
                        var B = this.tryEntries[i], E = B.completion;
                        if ("root" === B.tryLoc) return n("end");
                        if (B.tryLoc <= this.prev) {
                            var r = g.call(B, "catchLoc"), C = g.call(B, "finallyLoc");
                            if (r && C) {

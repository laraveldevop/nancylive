                                ...
                                <div class="items">
                                    <div class="item-content">
                                        <div class="user-profile">
                                            ...
                                            <img width="100px"  src="{{ asset(!empty($value->image)?'/public/'.$value->image:'backend/assets/img/avatars/profiles/avatar-1.jpg')}}" alt="avatar">
                                        ...
                                        <div class="action-btn">
                                            <a href="{{ url('image/'.$value->id. '/edit')}}"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 edit"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg></a>

                                            <form method="POST" style="display:inline;"
                                                  action="{{ route('image.destroy',$value->id) }}">
                                                @csrf
                                                @method('DELETE')

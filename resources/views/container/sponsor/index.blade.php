                            ...
                            @foreach($sponsor as $key=>$value)
                                <div class="items">
                                    <div class="item-content">
                                        ...
                                        <div class="action-btn">
                                            <a href="{{ url('sponsor/'.$value->id. '/edit')}}"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 edit"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg></a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="mt-0" action="{{ route('sponsor.destroy',$value->id) }}" method="post" >
                            @csrf
                            @method('DELETE')

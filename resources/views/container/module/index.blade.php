                                ...
                                <div class="items">
                                    <div class="item-content">
                                        ...
                                        <div class="user-email">
                                            ...
                                            <p class="usr-email-addr" data-email="{{ $value->module_name }}">{{ $value->module_name }}</p>
                                        </div>
                                        <div class="user-email">
                                            <p class="info-title">Detail : </p>
                                            <p class="usr-email-addr" data-email="{{ $value->detail }}">{{ $value->detail }}</p>
                                        </div>
...
{{--                                        <div class="action-btn">--}}
{{--                                            <a href="{{ url('module/'.$value->id. '/edit')}}"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 edit"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg></a>--}}

{{--                                            <form method="POST" style="display:inline;"--}}
{{--                                                  action="{{ route('module.destroy',$value->id) }}">--}}
{{--                                                @csrf--}}
{{--                                                @method('DELETE') <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user-minus delete"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="23" y1="11" x2="17" y2="11"></line></svg></form>--}}
{{--                                        </div>--}}
                                    </div>
                                </div>
                            @endforeach
